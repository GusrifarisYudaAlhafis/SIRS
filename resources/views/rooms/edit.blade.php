                ...
                <div class="row my-3">
                    <div class="col-md-12">
                        <div class="card r-0 shadow">
                            <form action="{{ route('rooms.update', $item->id) }}" method="post" class="needs-validation" novalidate>
                                @csrf
                                @method('put')
                                <div class="card no-b">
                                    <div class="card-body">
                                        ...
                                        <div class="form-row">
                                            <div class="col-md-8">
                                                <div class="form-group m-0">
                                                    ...
                                                    <input id="name" placeholder="Masukkan Nama Ruangan" class="form-control r-0 light s-12" type="text" name="name" value="{{ old('name') ?? $item->name }}" required>
                                                ...
                                                <div class="form-row">
                                                    <div class="form-group col-md-6 m-0">
                                                        ...
                                                        <select class="custom-select my-1 mr-sm-2 form-control r-0 light s-12" id="inlineFormCustomSelectPref" name="class" required>
                                                            <option value="{{ old('class') ?? $item->class }}">{{ old('class') ?? $item->class }}</option>
                                                    ...
                                                    <div class="form-group col-md-6 m-0">
                                                        ...
                                                        <select class="custom-select my-1 mr-sm-2 form-control r-0 light s-12" id="inlineFormCustomSelectPref" name="status" required>
                                                            <option value="{{ old('status') ?? $item->status }}">{{ old('status') ?? $item->status }}</option>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <input type="submit" class="btn btn-primary btn-xs" name="button" value="Ubah">
                                    </div>
                                </div>
                            </form>
                        </div>
